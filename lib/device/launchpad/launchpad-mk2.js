...
const colors = require("./color/rgb.js");
...
class Mk2 extends Launchpad {
	...
	normalizeColor(color) {
		...
		if (typeof color === "string") {
			// From color names
			return this.normalizeColor(this.colors.names[color]);
		}
		...
		if (typeof color === "object") {
			...
			const range = this.colors.rgb.range;
			...
			const range = this.colors.basic.range;
