...
class Device extends EventEmitter {
	...
	sendSysEx(
		...
		return this.send([240, manufacturerId, modelId, message, 247]);
	}
	// Send System Common (Universal System "Exclusive") MIDI bytes
	sendSysCom(message) {
		// Send message (status byte, message, EOX)
	...
	// or [object Device] (if for some reason it doesn't have a type name)
	get [Symbol.toStringTag]() {
		return this.constructor.type || "Device";
	}
