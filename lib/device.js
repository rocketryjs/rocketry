...
class Device extends EventEmitter {
	...
	sendSysEx(
		...
		// Structure message (all but status byte)
		message = [...manufacturerId, ...modelId, ...message, 247];
		// Prepend status byte with channel (240 - 255)
		addStatusByte(message, 240, channel);
		// Send
		return this.send(message);
	}
